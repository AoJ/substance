...
function createNetworks(callback) {
  ...
  graph.set({
    ...
    type: "/type/network",
    name: "Javascript",
    descr: "všemi milovaný, všemi používaný, všemi uctívaný skvějí programovací jazyk",
    color: "#82AA15",
  ...
  graph.set({
    ...
    type: "/type/network",
    name: "Servers",
    descr: "Nastavení, návody, zálohy, přístupy, závilosti a vše okolo našich serverů a vps",
    color: "#82AA15",
